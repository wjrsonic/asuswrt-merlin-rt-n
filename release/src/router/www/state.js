...
function show_banner(L3){// L3 = The third Level of Menu
	...
	banner_code +='<span style="font-family:Verdana, Arial, Helvetica, sans-serif;"><#General_x_FirmwareVersion_itemname#></span><a href="/Advanced_FirmwareUpgrade_Content.asp" style="color:white;"><span id="firmver" class="title_link"></span></a> <small>(M-8)</small>\n';
...
tabtitle[13] = new Array("", "Sysinfo", "Other Settings", "Run Cmd");
...
tablink[13] = new Array("", "Tools_Sysinfo.asp", "Tools_OtherSettings.asp", "Tools_RunCmd.asp");
