...
function show_banner(L3){// L3 = The third Level of Menu
	...
	banner_code +='<a href="javascript:logout();"><div style="margin-top:13px;margin-left:250px;" class="titlebtn" align="center"><span>'+multiLanguage_all_array[multi_INT][11]+'</span></div></a>\n';          //chang margin-left 100->300
 ...
 // banner_code +='<td valign="center" class="titledown" width="auto"><span id="firmver" class="time"></span></td>\n';
  ...
  banner_code +='<td width="730"></td><td><a id="helpAddress" href=""><img src="images/icon/help.png" title="help" /></a></td>\n';// change width 17->450
...
menuL1_link = new Array("", "task.asp", "as.asp");     //add by alan
...
function show_menu(){
	...
	for(i = 1; i <= menuL1_title.length-2; i++){
		if(menuL1_title[i] == "")
		  ...
		  menu1_code += '<div class="menu" id="option'+i+'"><a href="'+menuL1_link[i]+'">'+'<img border="0" src="images/New_ui/icon_index_'+i+'.png"/><div style="margin-top:-35px; margin-left:55px">'+menuL1_title[i]+'</div>\n';
		  menu1_code += '</a></div>\n';
		}
	}
		...
		for(var i = 1; i <= menuL2_title.length-1; ++i){
			if(i == menuL2_title.length-1){
				...
				if(menuL2_title[i] == "")
					...
					if(i == 1 && (multi_INT == 8 || multi_INT == 5 || multi_INT == 13 || multi_INT == 12 || multi_INT == 11 || multi_INT == 7 || multi_INT == 3 || multi_INT == 4 || multi_INT == 6)){
						menu2_code += '<div class="m1_r" id="option4">'+'<img width="50px" height="50px" style="margin-left:10px" border="0" src="images/New_ui/icon_index_setting.png"/><div style="margin-top:-40px; margin-left:65px">'+menuL2_title[i]+'</div>\n';
						}
						else{
					...
					if(i == 1 && (multi_INT == 8 || multi_INT == 5 || multi_INT == 13 || multi_INT == 12 || multi_INT == 11 || multi_INT == 7 || multi_INT == 3 || multi_INT == 4 || multi_INT == 6)){
						menu2_code += '<div class="menu" id="option4"><a href="'+menuL2_link[i]+'">'+'<img border="0" src="images/New_ui/icon_index_setting.png"/><div style="margin-top:-45px; margin-left:55px">'+menuL2_title[i]+'</div>';
						}
						else
					menu2_code += '<div class="menu" id="option4"><a href="'+menuL2_link[i]+'">'+'<img border="0" src="images/New_ui/icon_index_setting.png"/><div style="margin-top:-35px; margin-left:55px">'+menuL2_title[i]+'</div>';
...
function show_footer(){
		...
		( navigator.userAgent.match(/Mobile/i)))
	{
		...
		footer_code +='<span style="margin-right:150px; font-size:13px;"><a id="handToPhone" style="color:#CCC;">'+multiLanguage_all_array[multi_INT][13]+'</a> | <a id="handToPC" style="color:#F90;">'+multiLanguage_all_array[multi_INT][14]+'</a></span>\n';
		footer_code +='<span>'+multiLanguage_all_array[multi_INT][4]+'</span></div>\n';
		}
	else
	{
		footer_code +='<div align="center" class="copyright">'+multiLanguage_all_array[multi_INT][4]+'</div>\n';
		}
...
function submit_language(LanguageValue){
	...
	lang = 17;
	else if(LanguageValue == "HU")
	lang = 18;
	else if(LanguageValue == "RO")
	lang = 19;
...
function logout(){
	...
	if(confirm(multiLanguage_all_array[multi_INT][12])){
