...
*/
	...
	banner_code +='<input type="button" value='+multiLanguage_all_array[multi_INT][11]+' onclick="logout();" />';          //chang margin-left 100->300
...
function show_footer(){
	...
	footer_code ='<div align="center"><a id="handToPhone" style="color:#F90;">'+multiLanguage_all_array[multi_INT][13]+'</a> | <a id="handToPC" style="color:#CCC;">'+multiLanguage_all_array[multi_INT][14]+'</a></div>\n';
