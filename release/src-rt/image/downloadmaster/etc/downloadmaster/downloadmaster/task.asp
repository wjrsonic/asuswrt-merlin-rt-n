...
<script type="text/javascript" src="dm_function.js"></script>
...
<table class="content" align="center" cellpadding="0" cellspacing="0">
  <tr>
	<td valign="top" width="17">&nbsp;</td>
        ...
        <tbody>
        <tr>
        	<td><table width="720"><tr>
            <td>
        	<table id="AddTask">
                	<tr>
                    	<td align="center">
                        <div class="icon" id="icon_add" title="Add"><a href="javascript:showPanel();"></a></div>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
            ...
            <table id="Home">
            	<tbody>
                	<tr>
                    	<td align="center">
                        	<div class="icon" id="icon_home" title="Home" style="margin-left:13px;"><a id="homeAddress"></a></div>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                    	<td align="center" valign="middle" colspan="2">
                        <span id="multi_14"></span>
                        </td>
                    </tr>
                </tbody>
        	</table>
